...
import { AppDispatch, IProduct } from '../types';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.info_container}>
        <View style={styles.row}>
          ...
          <Text style={styles.price}>{convertIntToMoney(product.price)}</Text>
        </View>
        <View style={styles.features}>
          {product.features.map((feature: string) => (
            <Text style={styles.feature} key={feature}>
              {feature}
            </Text>
          ))}
        </View>
        <View style={styles.amount_container}>
          <Text style={styles.amount_text}>Quantidade</Text>
          <View style={styles.amount_button}>
            ...
            <Text style={styles.amount_button_text}>{amountInCart()}</Text>
            <Pressable
        ...
        <Pressable
          ...
          style={[
            ...
            {
              backgroundColor:
                amountInCart() > 0 ? DANGER_COLOR : PRIMARY_COLOR,
            },
          ]}
        >
